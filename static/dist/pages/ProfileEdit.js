...
const firstname = new FormRow({
    ...
    onBlur: function (event) {
        ...
        const error = validate(event.target.value, ["required" /* REQUIRED */, "alphabet" /* ALPHABET */]);
        if (error) {
...
const phone = new FormRow({
    ...
    onBlur: function (event) {
        ...
        // todo: унести в компонент ошибки
        const error = validate(event.target.value, ["required" /* REQUIRED */, "phone" /* PHONE */]);
        if (error) {
            const span = document.createElement("li");
            span.setAttribute("class", "props-list__error text-danger text-sm");
            span.textContent = error.message;
...
const username = new FormRow({
    ...
    onBlur: function (event) {
        ...
        // todo: унести в компонент ошибки
        const error = validate(event.target.value, ["required" /* REQUIRED */]);
        if (error) {
            const span = document.createElement("li");
            span.setAttribute("class", "props-list__error text-danger text-sm");
            span.textContent = error.message;
...
const email = new FormRow({
    ...
    onBlur: function (event) {
        ...
        // todo: унести в компонент ошибки
        const error = validate(event.target.value, ["required" /* REQUIRED */, "email" /* EMAIL */]);
        if (error) {
            const span = document.createElement("li");
            span.setAttribute("class", "props-list__error text-danger text-sm");
            span.textContent = error.message;
...
const newPassword = new FormRow({
    ...
    onBlur: function (event) {
        ...
        // todo: унести в компонент ошибки
        const error = validate(event.target.value, ["password_repeat" /* PASSWORD_REPEAT */]);
        if (error) {
            const span = document.createElement("li");
            span.setAttribute("class", "props-list__error text-danger text-sm");
            span.textContent = error.message;
